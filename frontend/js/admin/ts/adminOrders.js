...
let currentAdminOrderId = null; // To store ID for detail page actions
    ...
    try {
        ...
        if (result.data) {
            ...
            if (orderStatusSelect)
                orderStatusSelect.value = result.data.status;
        }
        else {
...
async function handleUpdateOrderStatus() {
    if (!currentAdminOrderId || !orderStatusSelect || !statusUpdateMessageEl || !updateStatusBtn)
        return;
