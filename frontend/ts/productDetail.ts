...
import { API_BASE_URL, getToken, updateCartCount, updateNav, removeToken } from './main.js'; // Adjust path if needed
...
function updateStockOnDetailPage(productIdFromEvent: string, newStock: number) {
    ...
    if (currentProductIdOnPage === productIdFromEvent) {
        ...
        let addToCartBtn = document.getElementById('add-to-cart-btn') as HTMLButtonElement | null;
        let outOfStockMessageEl = document.getElementById('out-of-stock-message') as HTMLParagraphElement | null;
