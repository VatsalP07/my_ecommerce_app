...
const addProductForm = document.getElementById('add-product-form') as HTMLFormElement | null;
...
if (addProductForm) {
    ...
    addProductForm.addEventListener('submit', async (e) => {
        ...
        if (!nameInput || !descriptionInput || !priceInput || !categoryInput || !stockInput) {
            ...
            if(errorElement) errorElement.textContent = "A form field is missing. Please contact support.";
            return;
        }
        ...
        const imageFilesInput = document.getElementById('productImages') as HTMLInputElement;
